...
//DECLARE_MODULE_V1("protocol/ircd-IRCa", true, _modinit, NULL, PACKAGE_STRING, "Shaltúre developers <https://github.com/shalture>");
...
struct cmode_ IRCa_status_mode_list[] = {
  { 'y', CSTATUS_IMMUNE	 },
  { 'q', CSTATUS_OWNER	 },
  { 'a', CSTATUS_PROTECT },
  { 'o', CSTATUS_OP	 },
...
struct cmode_ IRCa_prefix_mode_list[] = {
  { '*', CSTATUS_IMMUNE	 },
  { '~', CSTATUS_OWNER	 },
  { '&', CSTATUS_PROTECT },
  { '@', CSTATUS_OP	 },
...
struct cmode_ IRCa_user_mode_list[] = {
  { 'p', UF_IMMUNE   },
  { 'a', UF_ADMIN    },
  { 'i', UF_INVIS    },
  { 'o', UF_IRCOP    },
...
static bool IRCa_is_valid_hostslash(const char *host)
{
	const char *p;
	bool dot = false;
...
static void IRCa_wallops_sts(const char *reason)
{
...
static void IRCa_on_login(user_t *u, myuser_t *mu, const char *wantedhost)
{
...
static bool IRCa_on_logout(user_t *u, const char *account)
{
