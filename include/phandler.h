...
/* values for flags */
#define IRCD_CIDR_BANS			0x0001
#define IRCD_HOLDNICK			0x0002 /* supports holdnick_sts() */
#define IRCD_TOPIC_NOCOLOUR		0x0004
#define IRCD_SASL_USE_PUID		0x0008
#define IRCD_ENCAP_FJOIN		0x0010
